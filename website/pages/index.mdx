...
library can be tough. Between Rollup, Jest, `tsconfig`, and getting VSCode to play nicely…there is just a whole lot
...
Because the package is not published, you will need to copy the source code into an executable directory in your project and run commands directly with Node. I'm not sure I'll get around to documenting this before release, so use at your own risk!
